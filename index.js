...
async function startBot() {
  ...
  if (config.sessionID && config.sessionID.startsWith('𝖩𝖠𝖭𝖨𝖸𝖠-𝖬𝖣!')) {
    try {
      const [header, b64data] = config.sessionID.split('!');

      if (header !== 'KnightBot' || !b64data) {
        throw new Error("❌ Invalid session format. Expected '𝖩𝖠𝖭𝖨𝖸𝖠-𝖬𝖣!.....'");
      }
      ...
      console.log('📡 Session : 🔑 Retrieved from 𝖩𝖠𝖭𝖨𝖸𝖠-𝖬𝖣 Session');

    } catch (e) {
      console.error('📡 Session : ❌ Error processing 𝖩𝖠𝖭𝖨𝖸𝖠-𝖬𝖣 session:', e.message);
